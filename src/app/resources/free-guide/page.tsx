    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed top-4 right-4 z-50 print:hidden">
        <Button
          ...
          className="bg-[#C41E3A] hover:bg-[#a01830] text-white px-6 py-3 text-lg shadow-lg"
        >
          Download PDF
        </Button>
      </div>
      ...
      {/* Page 1: Cover */}
      <div className="min-h-screen bg-black flex items-center print:page-break-after-always">
      ...
      {/* Page 2: Introduction */}
      <div className="min-h-screen bg-black p-16 flex flex-col justify-center print:page-break-after-always">
        ...
        <div className="grid grid-cols-2 gap-16">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="text-center">
              ...
              <div className="text-white text-xl font-semibold mb-2">Property Value Increase</div>
              <div className="text-gray-400">Premium iron fencing can boost your home's value</div>
            </div>
            <div className="text-center">
              <div className="text-7xl font-bold text-white mb-4">30+</div>
              <div className="text-white text-xl font-semibold mb-2">Years of Beauty</div>
              <div className="text-gray-400">Powder-coated iron fencing lasts with minimal maintenance</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Page 3: Strategy #1 */}
      <div className="min-h-screen bg-black p-16 print:page-break-after-always">
        <h2 className="text-5xl font-bold text-white mb-4">Strategy #1: Choose the Right Style</h2>
        <h3 className="text-2xl text-[#C41E3A] mb-12">Match Your Home's Architecture</h3>
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          <div className="bg-[#C41E3A] p-8 rounded">
            <h4 className="text-2xl font-bold text-white mb-4">Traditional & Colonial</h4>
          ...
          <div className="bg-[#C41E3A] p-8 rounded">
            <h4 className="text-2xl font-bold text-white mb-4">Modern & Contemporary</h4>
            <p className="text-white leading-relaxed">
          ...
          <div className="bg-[#C41E3A] p-8 rounded">
            <h4 className="text-2xl font-bold text-white mb-4">Mediterranean & Spanish Revival</h4>
            <p className="text-white leading-relaxed">
          ...
          <div className="bg-[#C41E3A] p-8 rounded">
            <h4 className="text-2xl font-bold text-white mb-4">Craftsman Bungalows</h4>
            <p className="text-white leading-relaxed">
        ...
        <div className="bg-[#5a1520] border-2 border-[#C41E3A] rounded p-6">
          <p className="text-white">
            <strong className="text-lg">Pro Tip:</strong> Bring photos of your home to your consultation appointment. Our designers will create custom mockups showing exactly how different fence styles will complement your specific architecture.
          </p>
        </div>
      </div>
      ...
      {/* Page 4: Strategy #2 */}
      <div className="min-h-screen bg-black p-16 print:page-break-after-always">
        <h2 className="text-5xl font-bold text-white mb-4">Strategy #2: Select a Stunning Finish</h2>
        <h3 className="text-2xl text-[#C41E3A] mb-12">Make a Statement with Color & Protection</h3>
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          <div className="border-2 border-[#C41E3A] bg-[#1a1a1a] p-8 rounded">
            <h4 className="text-2xl font-bold text-white mb-4">Classic Matte Black</h4>
          ...
          <div className="border-2 border-[#C41E3A] bg-[#1a1a1a] p-8 rounded">
            <h4 className="text-2xl font-bold text-white mb-4">Bronze & Copper Tones</h4>
            <p className="text-gray-300 leading-relaxed">
          ...
          <div className="border-2 border-[#C41E3A] bg-[#1a1a1a] p-8 rounded">
            <h4 className="text-2xl font-bold text-white mb-4">Custom Color Matching</h4>
            <p className="text-gray-300 leading-relaxed">
          ...
          <div className="border-2 border-[#C41E3A] bg-[#1a1a1a] p-8 rounded">
            <h4 className="text-2xl font-bold text-white mb-4">Two-Tone Designs</h4>
            <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-[#C41E3A] rounded p-6">
          <p className="text-white">
            <strong className="text-lg">Pro Tip:</strong> Powder coating provides 10x the protection of traditional paint, resisting chipping, fading, and corrosion for decades with minimal maintenance required.
          </p>
        </div>
      </div>
      ...
      {/* Page 5: Strategy #3 */}
      <div className="min-h-screen bg-black p-16 print:page-break-after-always">
        <h2 className="text-5xl font-bold text-white mb-4">Strategy #3: Add Architectural Details</h2>
        <h3 className="text-2xl text-[#C41E3A] mb-12">The Details That Wow</h3>
        ...
        <div className="grid grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-[#C41E3A] pl-4">
                <h4 className="text-xl font-bold text-white mb-2">Custom Finials & Post Caps</h4>
                <p className="text-gray-300 leading-relaxed">
              ...
              <div className="border-l-4 border-[#C41E3A] pl-4">
                <h4 className="text-xl font-bold text-white mb-2">Scrollwork & Ornamental Elements</h4>
                <p className="text-gray-300 leading-relaxed">
              ...
              <div className="border-l-4 border-[#C41E3A] pl-4">
                <h4 className="text-xl font-bold text-white mb-2">Integrated Lighting</h4>
                <p className="text-gray-300 leading-relaxed">
              ...
              <div className="border-l-4 border-[#C41E3A] pl-4">
                <h4 className="text-xl font-bold text-white mb-2">Planters & Ring Holders</h4>
                <p className="text-gray-300 leading-relaxed">
          ...
          <div className="flex flex-col justify-center">
            ...
            />
            <div className="bg-[#5a1520] border-2 border-[#C41E3A] rounded p-4">
      ...
      {/* Page 6: Strategy #4 */}
      <div className="min-h-screen bg-black p-16 print:page-break-after-always">
        <h2 className="text-5xl font-bold text-white mb-4">Strategy #4: Create a Grand Entrance</h2>
        <h3 className="text-2xl text-[#C41E3A] mb-12">Statement Gates That Command Attention</h3>
        ...
        <div className="space-y-4 mb-8">
          <div className="bg-[#C41E3A] p-6 rounded flex items-start gap-4">
            <div className="bg-black rounded-lg w-12 h-12 flex items-center justify-center flex-shrink-0">
              <span className="text-[#C41E3A] text-2xl font-bold">1</span>
            </div>
            <div>
              <h4 className="text-xl font-bold text-white mb-2">Size & Proportion</h4>
              <p className="text-white leading-relaxed">
          ...
          <div className="bg-[#C41E3A] p-6 rounded flex items-start gap-4">
            <div className="bg-black rounded-lg w-12 h-12 flex items-center justify-center flex-shrink-0">
              <span className="text-[#C41E3A] text-2xl font-bold">2</span>
            </div>
            <div>
              <h4 className="text-xl font-bold text-white mb-2">Automation Adds Luxury</h4>
              <p className="text-white leading-relaxed">
          ...
          <div className="bg-[#C41E3A] p-6 rounded flex items-start gap-4">
            <div className="bg-black rounded-lg w-12 h-12 flex items-center justify-center flex-shrink-0">
              <span className="text-[#C41E3A] text-2xl font-bold">3</span>
            </div>
            <div>
              <h4 className="text-xl font-bold text-white mb-2">Decorative Gate Features</h4>
              <p className="text-white leading-relaxed">
          ...
          <div className="bg-[#C41E3A] p-6 rounded flex items-start gap-4">
            <div className="bg-black rounded-lg w-12 h-12 flex items-center justify-center flex-shrink-0">
              <span className="text-[#C41E3A] text-2xl font-bold">4</span>
            </div>
            <div>
              <h4 className="text-xl font-bold text-white mb-2">Dual Swing vs. Single</h4>
              <p className="text-white leading-relaxed">
          ...
          <div className="bg-[#C41E3A] p-6 rounded flex items-start gap-4">
            <div className="bg-black rounded-lg w-12 h-12 flex items-center justify-center flex-shrink-0">
              <span className="text-[#C41E3A] text-2xl font-bold">5</span>
            </div>
            <div>
              <h4 className="text-xl font-bold text-white mb-2">Premium Hardware</h4>
              <p className="text-white leading-relaxed">
        ...
        <div className="bg-[#5a1520] border-2 border-[#C41E3A] rounded p-6">
          <p className="text-white">
            <strong className="text-lg">Pro Tip:</strong> The gate is where visitors naturally pause before entering your property — make those precious seconds truly memorable with distinctive design.
          </p>
        </div>
      </div>
      ...
      {/* Page 7: Strategy #5 */}
      <div className="min-h-screen bg-black p-16 print:page-break-after-always">
        <h2 className="text-5xl font-bold text-white mb-4">Strategy #5: Coordinate All Elements</h2>
        <h3 className="text-2xl text-[#C41E3A] mb-12">Unified Design Strategy for Maximum Impact</h3>
        ...
        <div className="space-y-4 mb-8">
          <div className="flex items-start gap-4">
            <div className="bg-[#C41E3A] w-12 h-12 rounded flex items-center justify-center flex-shrink-0 text-2xl">
              🏛️
            </div>
            <div>
              <h4 className="text-xl font-bold text-white mb-2">Matching Railings</h4>
              <p className="text-gray-300 leading-relaxed">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-xl font-bold text-white mb-2">Window Grilles & Shutters</h4>
              <p className="text-gray-300 leading-relaxed">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-xl font-bold text-white mb-2">House Numbers & Mail Features</h4>
              <p className="text-gray-300 leading-relaxed">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-xl font-bold text-white mb-2">Outdoor Structures</h4>
              <p className="text-gray-300 leading-relaxed">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-xl font-bold text-white mb-2">Furniture & Accents</h4>
              <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-[#5a1520] border-2 border-[#C41E3A] rounded p-6">
          <p className="text-white">
            <strong className="text-lg">Pro Tip:</strong> A unified design approach signals quality craftsmanship to potential buyers and can positively influence property valuations by thousands of dollars.
          </p>
        </div>
      </div>
      ...
      <div className="min-h-screen bg-black p-16 print:page-break-after-always">
        <h2 className="text-5xl font-bold text-white mb-4 text-center">The Iron Works Solution Difference</h2>
        <h3 className="text-2xl text-[#C41E3A] mb-16 text-center">Why California Homeowners Choose Us</h3>
        ...
        <div className="grid grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              <div className="text-[#C41E3A] text-3xl">🏆</div>
              <div>
                <h4 className="text-2xl font-bold text-white mb-2">Master Craftsmanship</h4>
                <p className="text-gray-300 leading-relaxed">
            ...
            <div className="flex items-start gap-4">
              <div className="text-[#C41E3A] text-3xl">🤝</div>
              <div>
                <h4 className="text-2xl font-bold text-white mb-2">Personalized Service</h4>
                <p className="text-gray-300 leading-relaxed">
            ...
            <div className="flex items-start gap-4">
              <div className="text-[#C41E3A] text-3xl">✓</div>
              <div>
                <h4 className="text-2xl font-bold text-white mb-2">Licensed & Insured</h4>
                <p className="text-gray-300 leading-relaxed">
            ...
            <div className="flex items-start gap-4">
              <div className="text-[#C41E3A] text-3xl">📍</div>
              <div>
                <h4 className="text-2xl font-bold text-white mb-2">Local Expertise</h4>
                <p className="text-gray-300 leading-relaxed">
      ...
      {/* Page 9: Next Steps */}
      <div className="min-h-screen bg-black p-16 flex items-center print:page-break-after-always">
        <div className="grid grid-cols-2 gap-16 w-full">
          <div>
            <h2 className="text-5xl font-bold text-white mb-8">Ready to Transform Your Property?</h2>
          ...
          <div className="space-y-4">
            <div className="bg-[#C41E3A] p-6 rounded">
              <div className="text-white text-3xl mb-3">🏡</div>
              <h4 className="text-xl font-bold text-white mb-2">Property Assessment</h4>
              <p className="text-white">Evaluate your home's architectural style and specific needs</p>
            </div>

            <div className="bg-[#C41E3A] p-6 rounded">
              <div className="text-white text-3xl mb-3">🎨</div>
              <h4 className="text-xl font-bold text-white mb-2">Design Recommendations</h4>
              <p className="text-white">Professional suggestions with custom mockups showing options</p>
            </div>

            <div className="bg-[#C41E3A] p-6 rounded">
              <div className="text-white text-3xl mb-3">💰</div>
              <h4 className="text-xl font-bold text-white mb-2">Transparent Pricing</h4>
              <p className="text-white">Detailed quotes with no hidden costs or surprises</p>
            </div>

            <div className="bg-[#C41E3A] p-6 rounded">
              <div className="text-white text-3xl mb-3">📁</div>
              <h4 className="text-xl font-bold text-white mb-2">Portfolio Review</h4>
              <p className="text-white">View similar completed projects in your area</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Page 10: Contact */}
      <div className="min-h-screen bg-black p-16 flex flex-col justify-center items-center text-center">
        ...
        <div className="bg-[#1a1a1a] border-4 border-[#C41E3A] rounded-lg p-12 mb-12">
          <h3 className="text-4xl font-bold text-white mb-4">Iron Works Solution</h3>
          <p className="text-2xl text-[#C41E3A] font-semibold mb-6">Premium Custom Ironwork</p>
          <p className="text-xl text-white mb-6">Serving Southern California</p>
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-400 mt-2">Scan to visit our website</p>
          </div>

          <p className="text-lg text-gray-400">License #1141599</p>
        </div>

        <div className="w-full max-w-2xl border-t-2 border-[#C41E3A] pt-8">
